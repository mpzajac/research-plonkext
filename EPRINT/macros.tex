...
\DeclareRobustCommand{\mxout}[1] {{\color{blueish}{\sout{#1:}}}}
\newcommand{\chaya}[2] {\textcolor{magenta}{[{\footnotesize {\bf Chaya:} { {#1}}}]}}
\newcommand{\hamid}[2] {\textcolor{blue}{[{\footnotesize {\bf Hamid:} { {#1}}}]}}

...
computational special sound, and its simulator can provide indistinguishable proofs
...
\begin{lemma}
  ...
  $\marlinprot$ is 2-programmable trapdoor-less zero-knowledge.
\end{lemma}
\begin{proof}
...
\begin{corollary}
  ...
  $\epsur(\secpar) = 6 \cdot (\epsbind + \epsop + \epsk)$, and computational special sound

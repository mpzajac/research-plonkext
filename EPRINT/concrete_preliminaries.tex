...
\begin{remark}[Single adversarial updates after an honest setup.]\label{rem:upd}
	...
	Groth
	et al.\ show in~\cite{C:GKMMM18} that the two definitions are equivalent for polynomial commitment based SNARKs. We use this simpler definition in the following reduction.
\end{remark}

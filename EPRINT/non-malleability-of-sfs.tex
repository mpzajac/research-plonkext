...
\begin{lemma}
  ...
  \[
    \epscss(\secpar,\accProb, q) \leq \left(1 - \frac{\accProb - (q + 1) \left( \frac{\multconstr + \linconstr}{p}\right)}{1 - \frac{\multconstr + \linconstr}{p}}\right) + (\multconstr + \linconstr + 1) \cdot \epsuldlog (\secpar) + (\multconstr + \linconstr + 1) \cdot \epsid (\secpar)\,,
  \]

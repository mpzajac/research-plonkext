...
\begin{proof}
  ...
  \item Compute polynomial $\p{t} (X, Y) = \p{r} (X, 1) \p{r'}(X, Y) - \p{k} (Y)$ and pick $y$ such that $\p{t} (0, y) = 0$
  \item Output commitment $\gone{r} \gets \com(\srs, \multconstr, \p{r} (X, 1))$ and challenge $y$. 

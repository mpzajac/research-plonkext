...
\begin{lemma}
	...
	$\sonicprot$ is $(2, \multconstr + \linconstr + 1)$-forking special sound with security loss $\epss(\secpar)$ against
...
\begin{proof}
  ...
  adversary who breaks forking special soundness can be used to break a $\dlog$
...
\begin{corollary}[\COMMENT{Forking s}Simulation extractability of $\sonicprotfs$]
  ...
  polynomial commitment unique opening security -- and forking special sound with

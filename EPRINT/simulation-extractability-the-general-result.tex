...
\item $\bdv$ answers $\adv$'s SRS update and simulator queries \mxout{by programming
    the random oracle locally by using coins from $r_\simulator$} \changedm{by using
    coins $\rsim$}.  $\bdv$ maintains a list of instance-proof pairs $Q$ consisting
  of of all simulation queries made by $\adv$, and corresponding responses.

...
\oursubsub{Forking special soundness}\hamid{8.2}{I am a bit confused her! Do we still need the definition of forking special soundness? Can we not get the extraction bound by Attema result directly without discussing about forking special soundness (or what is called $k$-special soundness in Attema paper)?}

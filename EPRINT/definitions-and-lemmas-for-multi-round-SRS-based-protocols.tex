...
SNARKs.  
This construction can be found in \Cref{sec:SoKconstruction}. These signature schemes inherit the same properties as the underlying SNARK schemes and
they may rely on a structured reference string, which can be updatable or universal and
...
\begin{definition}[Simulation-extractable NIZK]
  ...
  cf.~\cref{fig:upd} and that produces an accepting proof

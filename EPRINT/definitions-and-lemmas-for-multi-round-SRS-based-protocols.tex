...
\textcolor{blue}{ Our definition of zero-knowledge for non-interactive arguments is
...
\item $\simulator_2' (\inp)$ that returns the first output of $\simulator (2, st, \inp)$.
\end{itemize}
Since the zero-knowledge property is only guaranteed for statements in the language,
the definition of ZK is with respect to oracle $\simulator_2$. That is,
$\simulator = (\simulator_1, \simulator_2)$.  We define

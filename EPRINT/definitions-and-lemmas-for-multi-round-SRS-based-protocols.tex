...
SNARKs.  These schemes inherit the same properties as the underlying SNARK schemes and
rely on a structured reference string, which can be updatable or universal, and they are

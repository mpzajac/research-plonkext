...
%% old SE definition ends --
\chaya{15.10}{remove the above defn?}
...
\chaya{13.10}{later, we should show $\simulator_2'$ for plonk/sonic/marlin. I think it will follow from TLS. But we should emphasize there how to define the above oracles so it is clear that $\simO$ can produce accepting proofs for false statements.}

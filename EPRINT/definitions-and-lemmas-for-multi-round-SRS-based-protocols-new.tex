...
\begin{definition}[Rewinding-based knowledge soundness]
	...
	\end{align*}
	Here, $\srs$ is the finalized SRS. List $Q_\ro$ contains all of the adversaries
	queries to $\ro$ and the random oracle's answers, $\abs{Q_\ro}\leq q$, and list $Q_\srs$ contains all $(\srs, \rho)$ of updated SRSs and their proofs.

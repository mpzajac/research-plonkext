...
\ourpar{Simulation-extractability for multi-message protocols.} \markulf{22.04}{Way too long and repeats stuff from the intro. We only need a very short paragraph.} Most recent SNARK schemes
...
\begin{lemma}[Generalized forking lemma~\cite{EPRINT:AttFehKlo21}]\label{lem:attema}
	Let $N = n_1 \cdots n_\mu$. Let $\proofsystem$ be a proof system that is knowledge sound \markulf{22.04}{Requiring knowledge soundness here seems circular.}

...
\begin{lemma}
  ...
  $\plonkprot$ is $(3, 3 \noofc + 16)$-updatable rewinding-based knowledge sound against algebraic adversaries who make up to $q$ random oracle queries with security loss 
  \[

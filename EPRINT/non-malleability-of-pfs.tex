...
\begin{lemma}
  ...
  Let $\plonkprot$ be zero-knowledge with security $\epszk(\secpar)$. Then $\plonkprot$ \hamid{1.5}{$\plonkprot_\fs$?} is 3-programmable trapdoor-less zero-knowledge

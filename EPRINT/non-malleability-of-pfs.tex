...
Given computational special soundness and $\ur{2}$ of $\plonkprot$, we invoke \cref{thm:se} and conclude that $\plonkprot_\fs$ is \COMMENT{forking }simulation-extractable.\hamid{19.1}{To conclude USE of Plonk, I think we should rely on TLS property too!}
...
computational special sound.\hamid{19.1}{Again, TLS is not mentioned?} We now make use of \cref{thm:se} and show that

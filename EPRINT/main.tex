...
\begin{abstract}
  The Fiat--Shamir transformation turns public-coin (three round) sigma protocol into
  ...
  transformation public-coin multi-round interactive protocols with SRS into

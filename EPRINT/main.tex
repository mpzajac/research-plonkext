...
\begin{abstract}
  The Fiat--Shamir transformation turns public-coin (three-message) sigma protocols into
  ...
  protocols that use both a structured reference string
  (SRS) and the random oracle model (ROM). While redundant in theory, this is the model 
  of choice for the most efficient practical argument systems to date.
  
  We then show sufficient conditions for compiling via the Fiat--Shamir
  ...
  results in the first security proof of direct constructions of updatable simulation-extractable SNARKs and succinct updatable SoK, avoiding unnecessary compilation overheads.
\end{abstract}

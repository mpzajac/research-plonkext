...
\markulf{30.04}{Do we really use this notation that much here? Lets adapt consistent notation with preliminaries and definition of Fiat--Shamir. Define notation there in detail call it here only brievely or by reference if needed.}
 We use $\zkproof[i]$ to denote $i$-th prover's

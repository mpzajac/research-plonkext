...
\textit{simulation-extractability} -- that corresponds much more
...
In practice, an adversary against a zkSNARK system also has access to proofs computed by honest parties that should be modeled as simulated proofs. The definition of knowledge soundness ignores the ability of an adversary
...
the chain for all blockchain participants to see. We thus argue that simulation extractability is a more suitable notion for robust protocol design.

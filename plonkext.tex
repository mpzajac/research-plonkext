...
First, following \cite{INDOCRYPT:FKMV12}, we need to show that from a number of
valid proofs that share some parts of the transcripts witnesses to instances
proven in $\plonkprot$ and $\sonicprot$  can be extracted. However the standard
definition of special soundness could not be met. First of all, the definition
...
of soundness which we call \emph{forking}. That is, we show that it is possible
...
a proof of simulation-soundness for a class of zero-knowledge proofs of

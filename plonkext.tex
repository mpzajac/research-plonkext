...
\begin{theorem}[Simulation extractability]
	...
	Let $\advse$ be a PPT adversary that can make up to $q$ random oracle queries and outputs an acceptable proof for $\plonkprotfs$ with probability at least $\widetilde{\accProb}$.
	...
	Then $\plonkprotfs$ is \hl{simulation-extractable with extraction error} $\eta = \ldots$.
	% \begin{multline*}
	% \[
	% 	1 - \left(

...
\end{theorem}
\michals{28.08}{Minor thing -- need to change the reduction for dlog -- the CRS for Plonk requires also $\gtwo{\chi}$, which is not given as a part of the dlog challenge.}
\begin{proof}

...
We claim here that such an analysis is not enough and one has to consider the security loss implied by the generalisation of the forking lemma or disclose a transformation that does not suffer from the the generalisation's inefficiency.

\subsubsection{Towards simulation-extractability.}

\subsubsection{Efficient simulation-soundness.}
Given that the security reduction for simulation-extractability 

...
Properly analyzing this heuristic security of zkSNARKs is of great importance
not the least because they are frequently used to secure crypto-currency assets
of immense value~\cite{REPO:Zcash20,ARXIV:RonZaj19,REPO:Zeth20,REPO:Celo20,REPO:Aztec20}.
...
states, as expressed in \cite{C:Fischlin05}, that for $3$-messages sigma
protocols, except for the first message, all messages sent by the prover are
...
\oursubsub{Forking simulation-extractability.} Given our modified, less

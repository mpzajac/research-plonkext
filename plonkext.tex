...
For the sake of completeness we also provide a reduction\footnote{Called sometimes \emph{a special extractor}.} $\rdv_\se$ that from a given tree of acceptable transcripts extracts a witness (effectively making $\advse$ lose). 

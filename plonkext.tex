...
\begin{definition}[$(k,n)$-forking special soundness]
  ...
  Let $\tdv$ be the
  algorithm below that rewinds $\ppt$ $\advse^{\simulator_\fs,
  ...
  $\bdv$ returns the index $i$ of the random oracle query made for challenge $k$, the set $Q$ of simulator random oracle indexes, the instance $\inp$, and the proof $\adv$ returns.
  ...
  We say that $\ps$ is $(1, \ldots, n, \ldots, 1)$-forking special sound if

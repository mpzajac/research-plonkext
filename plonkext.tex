...
Assume that the extractor knows $\chi$, what is justified since the extractor may know the trapdoor corresponding to the CRS. \task{8.05}{Explain in more details.}
...
\end{inparaenum}
 ...
 The extractor $\ext$ proceeds as follows: First it 
\qed
\end{proof}

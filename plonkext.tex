...
\begin{abstract}
	% Recent years brought rapid development of zero-knowledge SNARKs.   
...
% From a proof system $\proofsystem$ we require three properties
% \begin{description}
% 	\item[completeness]
% 	\item[soundness] 
% 	\item[zero knowledge]
...
\comment{
\begin{definition}[Weak simulation extractability]

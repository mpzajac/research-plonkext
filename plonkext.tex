...
\paragraph{On the importance of the simulation extractability.} \cite{AC:DHLW10}
\cite{AC:Groth07} \cite{EPRINT:AbdRamSla20} \cite{EPRINT:KZMQCP15}
...
\begin{lemma}
	...
	Let $\PCOM$ be a batched version of a KZG polynomial commitment \cite{AC:KatZavGol10} as described in \cite{EPRINT:GabWilCio19} then $\PCOM$ has the unique opening property. 
\end{lemma}
\begin{proof}
	Let 

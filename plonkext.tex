...
Fortunately, since the witness can be extracted by repeating only one round of the protocol, we can proceed as in a protocol that utylises only one challenge.
...
\end{lemma}
\begin{proof}
	We proceed similarly as in \cite{CCS:BelNev06}.

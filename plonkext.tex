...
\begin{definition}[Weakly $\ur{i}$-protocol]
	\label{def:wiur}
	Let $\proofsystem = (\prover, \verifier, \simulator_\zkproof)$ be a standard-model interactive proof system. 
	...
	We say that $\proofsystem$ has \emph{unique responses after $i$} if for any PPT adversary $\adv$ probability
	\[
		\condprob{
		\begin{aligned}

...
\end{lemma}
%
In case of a sigma protocol, $\zdv$ may be interpreted as a pack of algorithms
---the adversary $\adv$ that produces acceptable transcripts which we extract
the witness from and the simulator $\simulator_\ro$ that provides $\adv$ with
random oracle access.
The probability $\frkProb$ can be interpreted as
...
h^1_q$ responses if $Q_\ro$ has only $k$ elements.

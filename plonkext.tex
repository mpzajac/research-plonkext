...
\paragraph{Idealised verifier and verfication equations}
Usually the verifier $\verifier$ verifies messages send by the prover by
checking a number of equations depend on the instance, SRS and the proof. We

...
property with security $\epsur$, is $(n_1, \ldots, 1, n_l, 1, \ldots, n_\mu)$-special
sound.
...
\[
	\extProb \geq \frac{1}{q^{n_l - 1}} (\accProb - \epsur)^{n_l} -\eps\,,
\]
...
\begin{proof}		
  ...
  given to the prover after $\zkproof[i]$, and $\zkproof[i..j]$ to denote

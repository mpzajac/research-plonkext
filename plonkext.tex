...
\begin{lemma}
	...
	\michals{16.09}{$\plonkprot$ is an interactive protocol, but maybe the adversary should have access to simulated proofs nevertheless? (Or we just assume that the simulation is done without using trapdoor but by reprogramming the ro and we don't need to care)}
\end{lemma}
\begin{proof}

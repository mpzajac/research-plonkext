...
\begin{proof}
	...
	$k \in \NN$ be the number of committed polynomials, 
	$\vec{c} \in \GRP^k$ be the commitments,  
	$\vec{z} \in \FF_p^2$ be the two attributes the polynomials are evaluated at, $\vec{s} \in \FF_p^k$ the evaluations, and 
	$\vec{o} \in \FF_p^2$ be the commitment openings. We need to show that for every $\ppt$ adversary $\adv$	
	\[
		\Pr
			\left[
				\begin{aligned}

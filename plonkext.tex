...
$\PCOMs$, presented in \cref{fig:pcoms}. (Due to the lack of space, the
figures were moved to \cref{sec:additional_preliminaries}.)
%
%
...
transcript that does not break $\ur{3}$-ness of $\ps$, then $\waccProb \geq

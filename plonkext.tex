...
\subsection{Zero knowledge}
\michals{27.X}{Paste here the description of the simulator from the appendix.
Explain why the interactive Plonk is zk.}
...
comes from the same distribution as it was picked by an \hl{honest} verifier.

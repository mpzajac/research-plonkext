...
the real-proof polynomial $\p{t}(X)$ is random since the polynomials
$\p{a}(X), \p{b}(X), \p{c}(X)$ and $\p{z}(X)$ are random. Hence, a commitment to
...
honestly as well. \markulf{03.11.2020}{Not sure about the definition of random

...
\begin{proof}
	...
	The reduction $\rdvdlog$ proceeds as follows.\hamid{Chaya please check!}
	\begin{enumerate}
		...
		$\gtwo{\alpha \chi^{- \dconst}, \ldots, \alpha \chi^{-1}, \alpha \chi,
			\ldots, \alpha \chi^{\dconst}}$. Put this together with the $(\dconst, \dconst)$-ldlog instance to derive a SRS $\srs$.

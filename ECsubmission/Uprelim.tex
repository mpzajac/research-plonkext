...
In the following, our goal will be to show that recent efficient SNARKs are simulation extractable(even in the updatable setting), and therefore a perfect candidate to build better signatures of knowledge. 

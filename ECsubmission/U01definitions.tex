...
sound. Furthermore, the adversary gets to contribute to the SRS in the updatable setting which makes the analysis more complicated. We thus adapt special
soundness to forking soundness, and generalize the forking lemma and the unique response property for
...
\chaya{forking soundness, forking SE are all undefined at this point. rewrite below. or move the general forking lemma to after the SE definition.}

...
The result of Faust et al.\cite{INDOCRYPT:FKMV12} is for $3$-round protocols that require two transcripts for standard model extraction. Here, not only do we consider multi-round protocols, they require more than

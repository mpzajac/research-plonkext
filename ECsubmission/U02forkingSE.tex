...
%
		\ngame{2} Define an adversary $\bdv$ against forking soundness such that given access to oracles $\initU$ and $\ro$, randomness $r_\bdv$ internally runs $\advse^{\initU, \simO, \ro} (1^\secpar; r_\adv)$, where
		\begin{compactenum}
